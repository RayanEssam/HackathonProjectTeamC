...
| المهام | الوصف     | 
| :-------- | :------- | 
| `   تصميم الواجهات الجميلة، استخدام مكتبة لوتي للانيميشن، توفير صور للتطبيق
العمل على الأيكون وإستخدام خطوط خارجية` | `    تصميم الواجهات و تجربة المستخدم تصميم أيقونة التطبيق                     ` | 
...
- المساهمة في حل مشكله التصحر اللتي تعاني منها المملكة
- التوعية بأهمية التشجير وفوائدة المباشرة على صحة الإنسان
...
- إستخدام الخرائط 
- مشاكل التوافقية بين معالج آبل M1 وانتل
- دمج المكتبات
...
يسر فريق منصة فليغرسها  مساعدتكم والرد على جميع  استفساراتكم من خلال البريد الإلكتروني flyghrsha@info.com
